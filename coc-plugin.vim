"COC extensions
let g:coc_global_extensions = ['coc-tsserver', 'coc-styled-components', 'coc-css', 'coc-html', 'coc-json', 'coc-yank', 'coc-eslint', 'coc-snippets', 'coc-stylelint', 'coc-spell-checker']
